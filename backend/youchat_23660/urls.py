"""youchat_23660 URL Configuration
...
admin.site.site_header = "Youchat"
admin.site.site_title = "Youchat Admin Portal"
admin.site.index_title = "Youchat Admin"

# swagger
api_info = openapi.Info(
    title="Youchat API",
    default_version="v1",
    description="API documentation for Youchat App",
)
